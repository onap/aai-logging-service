...
public class AAILoggerAdapterTest {
    ...
    public void logStatementInfoParsingTest() {
        ...
        loggerAdapter.info(UnitTestMsgs.INFO_LOG_WITH_ARGS, fields, firstArg, secondArg);

        // Validate that the message was parsed from the bundle resource.
        logger.validateLogMsg(
            "UT0002I This is an info log with some arguments " + firstArg + " and " + secondArg);
    ...
    public void logStatementErrorParsingTest() {
        ...
        loggerAdapter.error(UnitTestMsgs.ERROR_LOG_WITH_ARGS, new LogFields(), firstArg, secondArg);

        // Validate that the message was parsed from the bundle resource.
        logger.validateLogMsg(
            "UT0002E This is an error log with some arguments " + firstArg + " and " + secondArg);
    }
    ...
    public void logStatementWarnParsingTest() {
        ...
        loggerAdapter.warn(UnitTestMsgs.WARN_LOG_WITH_ARGS, firstArg, secondArg);

        // Validate that the message was parsed from the bundle resource.
        logger.validateLogMsg(
            "UT0002W This is a warning log with some arguments " + firstArg + " and " + secondArg);
    }
    ...
    public void logStatementDebugParsingTest() {
        ...
        // Generate an ERROR log with arguments.
        loggerAdapter.debug(UnitTestMsgs.DEBUG_LOG_WITH_ARGS, firstArg, secondArg);

        // Validate that the message was parsed from the bundle resource.
        logger.validateLogMsg(
            "UT0001D This is a debug log with some arguments " + firstArg + " and " + secondArg);
    }
    ...
    public void logStatementTraceParsingTest() {
        ...
        // Generate an ERROR log with arguments.
        loggerAdapter.trace(UnitTestMsgs.TRACE_LOG_WITH_ARGS, firstArg, secondArg);

        // Validate that the message was parsed from the bundle resource.
        logger.validateLogMsg(
            "UT0002T This is a trace log with some arguments " + firstArg + " and " + secondArg);
        logger.validateLogLevel(EELFLogger.Level.TRACE);
    }
    ...
    public void formatMsgTest() {
        ...
        String expected2 = "UT0002I This is an info log with some arguments " + firstArg + " and " + secondArg;
        ...
        String message2 = loggerAdapter.formatMsg(UnitTestMsgs.INFO_LOG_WITH_ARGS, firstArg,
            secondArg);
